...
class TensorRTInference:
    ...
    def preprocess_frame(self, frame):
        """Preprocess frame for model input (ADAS, NHWC format)"""
...
def main():
    ...
    engine_path = "/home/deen/ros2_ws/src/automama/automama/perception/adas.engine"
