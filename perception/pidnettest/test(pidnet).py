...
class TensorRTInference:
    ...
    def postprocess(self, output_data, original_frame_shape, labels_to_show=[0]):
        """
        Postprocess the segmentation output and return a color-mapped image
        showing only specified label(s).
        """
    ...
    def infer(self, frame):
        ...
        # Setup tensor addresses using new API
        for i in range(self.engine.num_io_tensors):
            tensor_name = self.engine.get_tensor_name(i)
