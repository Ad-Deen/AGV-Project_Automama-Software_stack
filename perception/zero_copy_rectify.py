...
with open(os.path.join(calib_dir, "stereo_calibration_tuned.yaml")) as f:
...
map1_left, map2_left = cv2.initUndistortRectifyMap(K2, D2, R2, P2, image_size, cv2.CV_32FC1)
map1_right, map2_right = cv2.initUndistortRectifyMap(K1, D1 , R1, P1, image_size, cv2.CV_32FC1)
# --------------remap params setup ------------------------------------
